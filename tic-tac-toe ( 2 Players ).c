...
int playerscr1=0,playerscr2=0;                   //  Score.
...
void print()
{
    ...
    printf("\t%c  %c%c%c%c%c%c%c%c%c  %c  %c%c%c%c%c%c%c%c%c  %c  %c%c%c%c%c%c%c%c%c  %c    Score      :    1st Player %2d   |   2nd Player %2d\n",chh,d[3][0],d[3][1],d[3][2],d[3][3],d[3][4],d[3][5],d[3][6],d[3][7],d[3][8],chh,e[3][0],e[3][1],e[3][2],e[3][3],e[3][4],e[3][5],e[3][6],e[3][7],e[3][8],chh,f[3][0],f[3][1],f[3][2],f[3][3],f[3][4],f[3][5],f[3][6],f[3][7],f[3][8],chh,playerscr1,playerscr2);
