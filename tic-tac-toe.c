...
#include<stdio.h>
#include<stdlib.h>                              //  globally declaration of all needed arrays and variables.

char a[5][9],b[5][9],c[5][9],d[5][9],e[5][9],f[5][9],g[5][9],h[5][9],k[5][9],p1[9],p2[9],gm[50];
int check[9],x=1,y=0,z=0,choi=1,tr=0;

char chh=177;                                   //    characters of pattern declaration.

char chh2=178;                                  //    characters of win line declaration.

char chh3=248;                                  //    character of cross/zero pattern declaration.
...
void print()
{
    ...
    printf("\n");
    printf("\t%c             %c             %c             %c\n",chh,chh,chh,chh);
    printf("\t%c  %c%c%c%c%c%c%c%c%c  %c  %c%c%c%c%c%c%c%c%c  %c  %c%c%c%c%c%c%c%c%c  %c\n",chh,a[0][0],a[0][1],a[0][2],a[0][3],a[0][4],a[0][5],a[0][6],a[0][7],a[0][8],chh,b[0][0],b[0][1],b[0][2],b[0][3],b[0][4],b[0][5],b[0][6],b[0][7],b[0][8],chh,c[0][0],c[0][1],c[0][2],c[0][3],c[0][4],c[0][5],c[0][6],c[0][7],c[0][8],chh);
    printf("\t%c  %c%c%c%c%c%c%c%c%c  %c  %c%c%c%c%c%c%c%c%c  %c  %c%c%c%c%c%c%c%c%c  %c\n",chh,a[1][0],a[1][1],a[1][2],a[1][3],a[1][4],a[1][5],a[1][6],a[1][7],a[1][8],chh,b[1][0],b[1][1],b[1][2],b[1][3],b[1][4],b[1][5],b[1][6],b[1][7],b[1][8],chh,c[1][0],c[1][1],c[1][2],c[1][3],c[1][4],c[1][5],c[1][6],c[1][7],c[1][8],chh);
    printf("\t%c  %c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c  %c\n",chh,a[2][0],a[2][1],a[2][2],a[2][3],a[2][4],a[2][5],a[2][6],a[2][7],a[2][8],gm[0],gm[1],gm[38],gm[2],gm[3],b[2][0],b[2][1],b[2][2],b[2][3],b[2][4],b[2][5],b[2][6],b[2][7],b[2][8],gm[4],gm[5],gm[39],gm[6],gm[7],c[2][0],c[2][1],c[2][2],c[2][3],c[2][4],c[2][5],c[2][6],c[2][7],c[2][8],chh);
    printf("\t%c  %c%c%c%c%c%c%c%c%c  %c  %c%c%c%c%c%c%c%c%c  %c  %c%c%c%c%c%c%c%c%c  %c                      %c       %c\n",chh,a[3][0],a[3][1],a[3][2],a[3][3],a[3][4],a[3][5],a[3][6],a[3][7],a[3][8],chh,b[3][0],b[3][1],b[3][2],b[3][3],b[3][4],b[3][5],b[3][6],b[3][7],b[3][8],chh,c[3][0],c[3][1],c[3][2],c[3][3],c[3][4],c[3][5],c[3][6],c[3][7],c[3][8],chh,chh3,chh3);
    printf("\t%c  %c%c%c%c%c%c%c%c%c  %c  %c%c%c%c%c%c%c%c%c  %c  %c%c%c%c%c%c%c%c%c  %c                        %c   %c\n",chh,a[4][0],a[4][1],a[4][2],a[4][3],a[4][4],a[4][5],a[4][6],a[4][7],a[4][8],chh,b[4][0],b[4][1],b[4][2],b[4][3],b[4][4],b[4][5],b[4][6],b[4][7],b[4][8],chh,c[4][0],c[4][1],c[4][2],c[4][3],c[4][4],c[4][5],c[4][6],c[4][7],c[4][8],chh,chh3,chh3);
    printf("\t%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c    1st Player :          %c\n",chh,chh,chh,chh,chh,chh,chh,gm[40],chh,chh,chh,chh,chh,gm[30],chh,chh,chh,chh,chh,chh,chh,gm[41],chh,chh,chh,chh,chh,chh,chh,gm[31],chh,chh,chh,chh,chh,gm[42],chh,chh,chh,chh,chh,chh,chh,chh3);
    ...
    printf("\t%c  %c%c%c%c%c%c%c%c%c  %c  %c%c%c%c%c%c%c%c%c  %c  %c%c%c%c%c%c%c%c%c  %c\n",chh,d[1][0],d[1][1],d[1][2],d[1][3],d[1][4],d[1][5],d[1][6],d[1][7],d[1][8],chh,e[1][0],e[1][1],e[1][2],e[1][3],e[1][4],e[1][5],e[1][6],e[1][7],e[1][8],chh,f[1][0],f[1][1],f[1][2],f[1][3],f[1][4],f[1][5],f[1][6],f[1][7],f[1][8],chh);
    ...
    printf("\t%c  %c%c%c%c%c%c%c%c%c  %c  %c%c%c%c%c%c%c%c%c  %c  %c%c%c%c%c%c%c%c%c  %c                      %c %c %c %c %c\n",chh,d[3][0],d[3][1],d[3][2],d[3][3],d[3][4],d[3][5],d[3][6],d[3][7],d[3][8],chh,e[3][0],e[3][1],e[3][2],e[3][3],e[3][4],e[3][5],e[3][6],e[3][7],e[3][8],chh,f[3][0],f[3][1],f[3][2],f[3][3],f[3][4],f[3][5],f[3][6],f[3][7],f[3][8],chh,chh3,chh3,chh3,chh3,chh3);
    printf("\t%c  %c%c%c%c%c%c%c%c%c  %c  %c%c%c%c%c%c%c%c%c  %c  %c%c%c%c%c%c%c%c%c  %c                      %c       %c\n",chh,d[4][0],d[4][1],d[4][2],d[4][3],d[4][4],d[4][5],d[4][6],d[4][7],d[4][8],chh,e[4][0],e[4][1],e[4][2],e[4][3],e[4][4],e[4][5],e[4][6],e[4][7],e[4][8],chh,f[4][0],f[4][1],f[4][2],f[4][3],f[4][4],f[4][5],f[4][6],f[4][7],f[4][8],chh,chh3,chh3);
    printf("\t%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c    2nd Player :      %c       %c\n",chh,chh,chh,chh,chh,chh,chh,gm[45],chh,chh,chh,chh,chh,chh,chh,gm[34],chh,chh,chh,chh,chh,gm[46],chh,chh,chh,chh,chh,gm[35],chh,chh,chh,chh,chh,chh,chh,gm[47],chh,chh,chh,chh,chh,chh,chh,chh3,chh3);
    printf("\t%c      %c     %c%c      %c      %c%c     %c      %c                      %c       %c      \n",chh,gm[25],gm[36],chh,gm[27],chh,gm[37],gm[29],chh,chh3,chh3);
    printf("\t%c  %c%c%c%c%c%c%c%c%c  %c  %c%c%c%c%c%c%c%c%c  %c  %c%c%c%c%c%c%c%c%c  %c                      %c %c %c %c %c\n",chh,g[0][0],g[0][1],g[0][2],g[0][3],g[0][4],g[0][5],g[0][6],g[0][7],g[0][8],chh,h[0][0],h[0][1],h[0][2],h[0][3],h[0][4],h[0][5],h[0][6],h[0][7],h[0][8],chh,k[0][0],k[0][1],k[0][2],k[0][3],k[0][4],k[0][5],k[0][6],k[0][7],k[0][8],chh,chh3,chh3,chh3,chh3,chh3);
