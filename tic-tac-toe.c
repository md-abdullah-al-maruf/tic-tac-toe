...
int game()                                      //  It returns 1 for 1st player and 2 for 2nd player.
{
    int i,j;
...
{
    char ccc;
    printf("\n    Press enter to play again OR press any key to stop.");
    fflush(stdin);
    ccc=getch();
    if(ccc==13)                                   //    If user press enter, Game will start again.
    {
        return 1;
    }
    else
